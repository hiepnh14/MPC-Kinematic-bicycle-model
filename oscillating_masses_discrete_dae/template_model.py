...
def template_model(symvar_type='SX'):
    ...
    model.set_expression(expr_name='cost', expr=(_x[1,0]-2) ** 2+ (_x[3,0] - 0.1) ** 2)
    # model.set_expression(expr_name='cost', expr=(_x[1, 0] - 2) ** 2 + (_u - 0.2) ** 2)
    ...
    # model.set_alg('x_next', x_next-A@_x-np.array([_u[0,0]*cos(_x[2,0])], [_u[0,0]*sin(_x[2,0])], [_u[0,0]*tan(_u[0,0])/1], [1]))
